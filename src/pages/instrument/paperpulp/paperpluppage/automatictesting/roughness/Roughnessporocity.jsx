        ...
        <Layout>
            ...
            <div className="container">
                <div className="section-title text-center">
                    <h1>Automated Roughness & Porosity</h1>
                </div>
            </div>
            <section id="portfolio-details" className="portfolio-details" style={{ backgroundColor: 'white', marginBottom: '8.5rem' }}>
                <div className="container">
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Automated Roughness & Porosity</h3>
...
export default RoughnessPorosity;
