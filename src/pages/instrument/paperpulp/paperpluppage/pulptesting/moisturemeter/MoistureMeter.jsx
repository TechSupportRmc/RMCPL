...
const MoistureMeter = () => {
    ...
    const images = [
        '/img/instruments/MoistureMeter.png',
        '/img/instruments/MoistureMeter.png'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Moisture Meter</h3>
                                <p className='descriptionHead' style={{ textAlign: 'justify' }}>
                                    The Model DC-2000-BP is calibrated to test the moisture content in bales of scrap paper materials. This easy
                                    to-operate instrument can be used in factories, mills and yards. the probe can be pushed through a wet surface
                                    to give an accurate reading of the moisture below, at any depth or successive depths.
                                </p>
                            </div>
