...
const BoxCompressionTest = () => {
    ...
    const images = [
        '/img/instruments/Box-Compression.png',
        '/img/instruments/Box-Compression.png'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Box Compression Test</h3>
...
export default BoxCompressionTest
