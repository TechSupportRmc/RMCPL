...
const PeneumaticCutter = () => {
    ...
    const images = [
        '/img/instruments/Pneumatic-cutter.png',
        '/img/instruments/Pneumatic-cutter.png'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Peneumatic Cutter</h3>
...
export default PeneumaticCutter
