...
const DoubleBladeCutter = () => {
    ...
    const images = [
        '/img/instruments/Double-blade.png',
        '/img/instruments/Double-blade.png'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Double Blade Cutter</h3>
...
export default DoubleBladeCutter
