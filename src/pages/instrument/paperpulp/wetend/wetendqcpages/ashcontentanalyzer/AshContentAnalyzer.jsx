...
const AshContentAnalyzer = () => {
    ...
    const images = [
        '/img/instruments/aca-0827ff0c.jpg',
        '/img/instruments/aca-0827ff0c.jpg'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Ash Content Analyzer</h3>
...
export default AshContentAnalyzer
