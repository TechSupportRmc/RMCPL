...
const PDAhigh = () => {
    ...
    const images = [
        '/img/instruments/PDA.C_02_HVL_Module_High_Viscous_liquid (1).png',
        '/img/instruments/PDA.C_02_HVL_Module_High_Viscous_liquid (1).png'
    ];
        ...
        <Layout>
            ...
            <div className="container">
                <div className="section-title text-center" style={{ marginBottom: '2rem' }}>
                    <h1>PDA With High Viscous Liquid</h1>
                </div>
            </div>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>PDA With High Viscous Liquid</h3>
