...
const OpacityMeterPlasticFlim = () => {
    ...
    const images = [
        '/img/instruments/OpacityMeterPlastic.png',
        '/img/instruments/OpacityMeterPlastic.png'
    ];
        ...
        <Layout>
            ...
            <div className="container">
                <div className="section-title text-center" style={{ marginBottom: '2rem' }}>
                    <h1>Opacity Meter Plastic Flim</h1>
                </div>
            </div>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Opacity Meter Plastic Flim</h3>
...
export default OpacityMeterPlasticFlim
