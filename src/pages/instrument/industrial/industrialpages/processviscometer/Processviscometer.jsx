...
const Processviscometer = () => {
    ...
    const images = [
        '/img/instruments/process_viscometer.jpg',
        '/img/instruments/process_viscometer.jpg'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Process Viscometerr</h3>
...
export default Processviscometer
