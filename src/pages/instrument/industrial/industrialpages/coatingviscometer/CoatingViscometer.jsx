...
const CoatingViscometer = () => {
    ...
    const images = [
        '/img/instruments/Coating=sofine.jpg',
        '/img/instruments/Coating=sofine.jpg'
    ];
       ...
       <div className="bread">
            ...
            <div className="container">
                <div className="section-title text-center" style={{ marginBottom: '2rem' }}>
                    <h1>Process Viscometer :Sofine</h1>
                </div>
            </div>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Process Viscometer :Sofine</h3>
                                <p className='descriptionHead' style={{ textAlign: 'justify' }}>
                                A “process viscometer” is a unit used for measuring the viscosity directly installed in the process line. The term “inline” is used to describe the situation in which all the liquid passes the process viscometer; whereas “online” means that the viscometer will be installed in a bypass and therefore just a part of the liquid passes the viscometer.                                </p>
                            </div>
...
export default CoatingViscometer
