...
const RDChargeAnalyzerSystem = () => {
    ...
    const images = [
        '/img/instruments/Charge_Analyzer_System.png',
        '/img/instruments/Charge_Analyzer_System.png'
    ];
        ...
        <Layout>
            ...
            <div className="container">
                <div className="section-title text-center" style={{ marginBottom: '2rem' }}>
                    <h1>Charge Analyzer System & Fibre potential Analyser</h1>
                </div>
            </div>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Charge Analyzer System & Fibre potential Analyser</h3>
...
export default RDChargeAnalyzerSystem
