...
const DigitalBenchtopViscometer = () => {
    const settings = {
        dots: true,
        infinite: true,
        speed: 500,
        ...
        <Layout>
            ...
            <div className="container">
                <div className="section-title text-center" style={{ marginBottom: '2rem' }}>
                    <h1>Digital Benchtop Viscometer</h1>
                </div>
            </div>
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Digital Benchtop Viscometer</h3>
                                <p className='descriptionHead' style={{ textAlign: 'justify' }}>
                                    Viscosity is very important criteria in process & lab. A QUICK AND RELIABLE SYSTEM FOR VISCOSITY MEASUREMENT IN THE LAB This instrument operates on resonance frequency principle
                                    which is least sensitive to Vibration, shocks etc. Since there is no moving part, no wear & tear, No frequent
                                    maintenance & calibration. No requirement of changing spindles as per other techniques so time saving. and accurate.
                                </p>
                            </div>
...
export default DigitalBenchtopViscometer
