...
const AmmoniumProb = () => {
    ...
    const images = [
        '/img/instruments/Ammonium-prob.jpg',
        '/img/instruments/Ammonium-prob.jpg'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>Ammonium Prob</h3>
                                <p className='descriptionHead' style={{ textAlign: 'justify' }}>
                                    Gas Sensing Probe The ammonia electrode measures ammonia gas in aqueous solutions, or ammonium ions that have been converted to gas by the addition of a strong base. The electrode is a complete electrochemical cell consisting of a glass pH electrode and a reference electrode.                                 </p>
                            </div>
