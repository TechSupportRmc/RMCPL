...
const PackagingTesting = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const querySnapshot = await db.collection('PackagingTesting').get();
                            ...
                            <div className="carousel-container">
                                <div className="container">
                                    <div className="text" id='text'>
                                        <h2 className="animate__animated animate__fadeInDown">Packaging Testing</h2>
...
export default PackagingTesting;
