...
const PDAHighViscous = () => {
    ...
    const images = [
        '/img/instruments/PDA.C_02_HVL_Module_High_Viscous_liquid.png',
        '/img/instruments/PDA.C_02_HVL_Module_High_Viscous_liquid.png'
    ];
                    ...
                    <div className="row gy-4">
                        ...
                        <div className="col-lg-4">
                            <div className="portfolio-info" style={{ backgroundColor: 'white' }}>
                                <h3 className='pageheading'>PDA High Viscous Liquid</h3>
